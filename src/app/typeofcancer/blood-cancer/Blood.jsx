                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="lg:grid grid-cols-1 lg:grid-cols-12 gap-10 lg:mt-10 mt-4 px-5 w-full max-w-7xl">
                        <div className="relative bg-white px-8 py-10 shadow-lg rounded-2xl col-span-9 lg:-mt-40">
                            ...
                            <p className='text-gray-700 text-base'>There are three main types of blood cancer:</p>
                            <ol className='list-decimal list-inside'>
                                <li className="text-lg font-semibold text-gray-900 mt-2 mb-3">
                                    Leukemia
                                </li>
                                ...
                                <li className="text-lg font-bold text-gray-900 mt-2 mb-3">
                                    Lymphoma
                                </li>
                                ...
                                <p className='text-semibold text-gray-700 mt-3 font-semibold'>Common symptoms:</p>
                                <ul className="list-disc list-inside text-gray-700 mt-2 space-y-2">
