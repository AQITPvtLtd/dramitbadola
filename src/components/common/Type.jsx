        ...
        <div className='px-5'>
            <div className="shadow-2xl bg-white px-4 py-4 rounded-lg w-auto h-fit mt-10 lg:mt-0">
                ...
                <div className="pt-3">
                    <Link
                        href={`/contact`}
                        className="px-4 py-2 bg-[#d0342c] text-white text-md rounded-lg block text-center transition-all border-2 border-transparent hover:border-[#d0342c] hover:text-black hover:bg-white"
                    >
